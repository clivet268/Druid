package com.Clivet268.Druid.Client.Render;
...
public class TileEntityDruidHeartRenderer extends TileEntitySpecialRenderer<TileEntityDruidHeart>
{
    private static final ResourceLocation END_SKY_TEXTURE = new ResourceLocation(Druid.MODID,"textures/tileentity/bs.png");
    ...
    public void render(TileEntityDruidHeart te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
