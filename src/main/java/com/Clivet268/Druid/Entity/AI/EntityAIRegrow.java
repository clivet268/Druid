    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            if (neargrowable != null) {
                ...
                System.out.println("check1 " + ((DruidEntity)this.druid).getBrews());
            ...
            //if (this.eatingGrassTimer == 4) {
                 ...
                 */
                    ...
                    for (int i = 5 + new Random().nextInt(12); i >= 0; i--) {
                        Minecraft.getInstance().particles.addEffect(new LifeParticle(this.entityWorld, this.druid.posX, this.druid.posY, this.druid.posZ, (new Random().nextDouble()-0.5)/3, 0, (new Random().nextDouble()-0.3)/3, LifeParticle.LifeType.REGROWTH));
                    }
