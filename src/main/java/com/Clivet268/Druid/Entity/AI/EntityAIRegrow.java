            ...
            //if (this.eatingGrassTimer == 4) {
                 ...
                 */
                    ...
                    for (int i = 5 + new Random().nextInt(12); i >= 0; i--) {
                        Minecraft.getInstance().world.addParticle(RegistryHandler.REGROW.get(),this.druid.posX, this.druid.posY, this.druid.posZ,(new Random().nextDouble()-0.5)/3, 0, (new Random().nextDouble()-0.3)/3);
                    }
