package com.Clivet268.Druid.World.Features.Structures;
...
//TODO lang, this is unrelated but finish the lang files, ongoing

public class DruidVillagePieces
{
	/*
	 ...
	 */
	private static final ResourceLocation TREE_HOUSE1 = new ResourceLocation(Druid.MODID + ":tree_house3");
	private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(TREE_HOUSE1, new BlockPos(0, -7, 0));
	...
	public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random)
	{
		...
		pieceList.add(new DruidVillagePieces.Piece(templateManager, TREE_HOUSE1, blockpos, rotation));
	}
	...
	public static class Piece extends TemplateStructurePiece
	{
		...
		{
			super(Features.tree_house2, 0);
			this.resourceLocation = resourceLocationIn;
			BlockPos blockpos = DruidVillagePieces.OFFSET.get(resourceLocation);
		...
		{
			super(Features.tree_house2, tagCompound);
		...
		{
			PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
			BlockPos blockpos = DruidVillagePieces.OFFSET.get(this.resourceLocation);
