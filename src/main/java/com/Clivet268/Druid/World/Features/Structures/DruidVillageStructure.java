...
public class DruidVillageStructure extends Structure<NoFeatureConfig>
{
    public DruidVillageStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return Druid.MODID + ":druid_village";
    }
	...
	{
		return DruidVillageStructure.Start::new;
	}
...
//		}
	...
	public static class Start extends StructureStart
	{
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
		{
			...
			DruidVillagePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
            ...
            Druid.LOGGER.log(Level.DEBUG, "Rundown House at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
