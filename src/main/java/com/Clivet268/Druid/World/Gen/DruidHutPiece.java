...
public class DruidHutPiece {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        private void func_204754_a(TemplateManager p_204754_1_) {
            ...
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.field_204755_d).setReplacedBlock(Blocks.AIR).setMirror(Mirror.NONE).setCenterOffset(DruidHutPiece.STRUCTURE_OFFSET);
